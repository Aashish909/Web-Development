...
const App = () => {
  ...
  // const filteredData = data.matchDetails.filter((item)=>item.matchDetailsMap)
  const filteredData = data.matchDetails.filter(
  ...
  async function fetchData() {
    ...
    const options = {
      method: "GET",
      headers: {
        "x-rapidapi-key": "fc98fda1c4msh004be3beb327abcp191975jsn55709ada9397",
